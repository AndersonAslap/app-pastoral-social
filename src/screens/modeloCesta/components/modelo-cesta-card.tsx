...
import { UsersRoundIcon, ChevronRight, Boxes } from "lucide-react-native";
...
export default function ModeloCestaCard({ item, onPress }: Props) {
  return (
    <Pressable
        onPress={onPress}
    ...
    >
      <HStack alignItems="center" space="lg">
        <Icon as={Boxes} size="lg" color="$pink500" />
