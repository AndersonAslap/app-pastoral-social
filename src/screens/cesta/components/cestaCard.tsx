...
import { Package, Eye, Truck, Trash } from "lucide-react-native";
...
export const CestaCard = ({ cesta, onDetalhes, onCancelar, onEntregar }: CestaCardProps) => {
  ...
  const handleOpenConfirmCancelarCesta = () => {
    setDialogConfirm(true);
  }

  const handleCancelarCesta = () => {
    setDialogConfirm(false);

    setTimeout(() => {
      onCancelar(cesta.idCesta);
    }, 0);
  }
